 ...
 //   lateinit var utils: Utils
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     //   utils?.getFirebaseRegisterId()
      appBarConfiguration = AppBarConfiguration(
        ...
        if (PrefManager.getString(Constant.LANGUAGE).equals("")) {
            PrefManager.setString(Constant.LANGUAGE, "en")
        }
        setLocale(PrefManager.getString(Constant.LANGUAGE))
        //checkForPermission()
    }
   ...
   /* fun handlerMethod() {
    ...
    fun setLocale(lang: String?) {
        ...
        PrefManager.setString(Constant.LANGUAGE, lang)
    }
}
